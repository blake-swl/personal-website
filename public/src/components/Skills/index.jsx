...
import check from '../../../dist/images/greencheck.jpg';
  ...
  <div id="skills" >
    ...
    <div className="mainSkills" data-aos="fade-up">
      <div className="javascript" data-aos="fade-up">JavaScript
        <Progress percent={90} theme={{ active: {symbol: 'Advanced', trailColor: '#535B63', color: '#B5D24B'}}}/>
      </div>
      <div className="react" data-aos="fade-up">React
        <Progress percent={95} theme={{ active: {symbol: 'Expert', trailColor: '#535B63', color: '#B5D24B'}}}/>
      </div>
      ...
      <div className="graphql" data-aos="fade-up">GraphQL
        <Progress percent={85} theme={{ active: {symbol: 'Intermediate', trailColor: '#535B63', color: '#B5D24B'}}}/>
      </div>
      <div className="enthusiasm" data-aos="fade-up">Enthusiasm
        <Progress percent={100} status="active" theme={{ active: {symbol: '👍🏻', trailColor: '#535B63', color: '#B5D24B'}}} />
      </div>
    </div>
    ...
    <div className="moreSkills">
      <div className="aws" data-aos="fade-up">
        ...
        type="circle" percent={100} status="active" theme={{ active: {symbol: <img src={check} style={{width: "50%"}}/> , trailColor: '#535B63', color: '#B5D24B'}}} />
        AWS EC2
      </div>
