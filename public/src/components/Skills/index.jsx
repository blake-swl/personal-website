    ...
    <div className="skills">
      ...
      <div className="mainSkills">
        <div className="javascript">JavaScript 
          <Progress percent={95} theme={{ active: {trailColor: '#535B63', color: '#8AF3FF'}}}/>
        </div>
        <div className="react">React
          <Progress percent={90} theme={{ active: {trailColor: '#535B63', color: '#8AF3FF'}}}/>
        </div>
        <div className="node">Node
          <Progress percent={85} theme={{ active: {trailColor: '#535B63', color: '#8AF3FF'}}}/>
        </div>
        <div className="htmlcss">HTML5/CSS3
          <Progress percent={92} theme={{ active: {trailColor: '#535B63', color: '#8AF3FF'}}}/>
        </div>
      ...
      <div className="moreSkills">
        ...
        type="circle" percent={100} theme={{ active: {trailColor: '#535B63', color: '#8AF3FF'}}} />
